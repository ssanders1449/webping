...
func TestWebRegionError(t *testing.T) {
	WebErr := errors.New("something bad")
	r := WebRegion{Error: WebErr}
...
func TestWebRegionCheckLatencyHTTP(t *testing.T) {
	...
	regions.SetTarget(func(r *WebRegion) {
		r.Target = &tt
	})
...
func TestWebRegionCheckLatencyTCP(t *testing.T) {
...
func TestWebRegionsLen(t *testing.T) {
	regions := GetRegions()
...
func TestWebRegionsLess(t *testing.T) {
	regions := GetRegions()
...
func TestWebRegionsSwap(t *testing.T) {
	regions := GetRegions()
...
func TestWebRegionsSetService(t *testing.T) {
	regions := GetRegions()
	service := "ec2"
...
func TestWebRegionsSetCheckType(t *testing.T) {
	regions := GetRegions()
	checkType := CheckTypeHTTP
...
func TestWebRegionsSetDefaultTarget(t *testing.T) {
	regions := GetRegions()
	service := "ec2"
	...
	want := fmt.Sprintf("https://ec2.%s.amazonweb.com/ping?x=", regions[0].Code)
